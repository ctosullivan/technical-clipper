...
- **Value:** 0 · **char:** `A` · **:** 16 · **Value:** `Q` · **char:** 32 · **:** `g` · **value:** 48 · **char:** `w`
- **Value:** 1 · **char:** `B` · **:** 17 · **Value:** `R` · **char:** 33 · **:** `h` · **value:** 49 · **char:** `x`
- **Value:** 2 · **char:** `C` · **:** 18 · **Value:** `S` · **char:** 34 · **:** `i` · **value:** 50 · **char:** `y`
- **Value:** 3 · **char:** `D` · **:** 19 · **Value:** `T` · **char:** 35 · **:** `j` · **value:** 51 · **char:** `z`
- **Value:** 4 · **char:** `E` · **:** 20 · **Value:** `U` · **char:** 36 · **:** `k` · **value:** 52 · **char:** `0`
- **Value:** 5 · **char:** `F` · **:** 21 · **Value:** `V` · **char:** 37 · **:** `l` · **value:** 53 · **char:** `1`
- **Value:** 6 · **char:** `G` · **:** 22 · **Value:** `W` · **char:** 38 · **:** `m` · **value:** 54 · **char:** `2`
- **Value:** 7 · **char:** `H` · **:** 23 · **Value:** `X` · **char:** 39 · **:** `n` · **value:** 55 · **char:** `3`
- **Value:** 8 · **char:** `I` · **:** 24 · **Value:** `Y` · **char:** 40 · **:** `o` · **value:** 56 · **char:** `4`
- **Value:** 9 · **char:** `J` · **:** 25 · **Value:** `Z` · **char:** 41 · **:** `p` · **value:** 57 · **char:** `5`
- **Value:** 10 · **char:** `K` · **:** 26 · **Value:** `a` · **char:** 42 · **:** `q` · **value:** 58 · **char:** `6`
- **Value:** 11 · **char:** `L` · **:** 27 · **Value:** `b` · **char:** 43 · **:** `r` · **value:** 59 · **char:** `7`
- **Value:** 12 · **char:** `M` · **:** 28 · **Value:** `c` · **char:** 44 · **:** `s` · **value:** 60 · **char:** `8`
- **Value:** 13 · **char:** `N` · **:** 29 · **Value:** `d` · **char:** 45 · **:** `t` · **value:** 61 · **char:** `9`
- **Value:** 14 · **char:** `O` · **:** 30 · **Value:** `e` · **char:** 46 · **:** `u` · **value:** 62 · **char:** `+`
- **Value:** 15 · **char:** `P` · **:** 31 · **Value:** `f` · **char:** 47 · **:** `v` · **value:** 63 · **char:** `/`
...
- **Input\ (ASCII):** 8-bit\ decimal value · **Letter (ASCII):** 77 · **M:** 97 · **a:** 110
- **Input\ (ASCII):** Hexadecimal\ value · **Letter (ASCII):** 4 · **M:** D · **a:** 6 · **n:** 1 · **col6:** 6 · **col7:** E
- **Input\ (ASCII):** Bits · **Letter (ASCII):** 0 · **M:** 1 · **a:** 0 · **n:** 0 · **col6:** 1 · **col7:** 1 · **col8:** 0 · **col9:** 1 · **col10:** 0 · **col11:** 1 · **col12:** 1 · **col13:** 0 · **col14:** 0 · **col15:** 0 · **col16:** 0 · **col17:** 1 · **col18:** 0 · **col19:** 1 · **col20:** 1 · **col21:** 0 · **col22:** 1 · **col23:** 1 · **col24:** 1 · **col25:** 0
- **Input\ (ASCII):** Encoded\ (Base64) · **Letter (ASCII):** 6-bit\ decimal value · **M:** 19 · **a:** 22 · **n:** 5 · **col6:** 46
- **Input\ (ASCII):** Letter\ (Base64 alphabet) · **Letter (ASCII):** T · **M:** W · **a:** F · **n:** u
- **Input\ (ASCII):** Byte · **Letter (ASCII):** 84 · **M:** 87 · **a:** 70 · **n:** 117
...
- **Input\  (ASCII):** 8-bit \  decimal value · **Letter (ASCII):** 77 · **M:** 97
- **Input\  (ASCII):** Hexadecimal\ value · **Letter (ASCII):** 4 · **M:** D · **a:** 6 · **:** 1
- **Input\  (ASCII):** Bits · **Letter (ASCII):** 0 · **M:** 1 · **a:** 0 · **:** 0 · **col6:** 1 · **col7:** 1 · **col8:** 0 · **col9:** 1 · **col10:** 0 · **col11:** 1 · **col12:** 1 · **col13:** 0 · **col14:** 0 · **col15:** 0 · **col16:** 0 · **col17:** 1 · **col18:** 0 · **col19:** 0 · **col20:**  · **col21:**  · **col22:**  · **col23:**  · **col24:**  · **col25:** 
- **Input\  (ASCII):** Encoded\ (Base64) · **Letter (ASCII):** 6-bit\ decimal value · **M:** 19 · **a:** 22 · **:** 4 · **col6:** Padding
- **Input\  (ASCII):** Letter\ (Base64 alphabet) · **Letter (ASCII):** T · **M:** W · **a:** E · **:** =
- **Input\  (ASCII):** Byte · **Letter (ASCII):** 84 · **M:** 87 · **a:** 69 · **:** 61
...
- **Input\ (ASCII):** 8-bit\ decimal value · **Letter (ASCII):** 77
- **Input\ (ASCII):** Hexadecimal\ value · **Letter (ASCII):** 4 · **M:** D
- **Input\ (ASCII):** Bits · **Letter (ASCII):** 0 · **M:** 1 · **:** 0 · **col5:** 0 · **col6:** 1 · **col7:** 1 · **col8:** 0 · **col9:** 1 · **col10:** 0 · **col11:** 0 · **col12:** 0 · **col13:** 0 · **col14:**  · **col15:**  · **col16:**  · **col17:**  · **col18:**  · **col19:**  · **col20:**  · **col21:**  · **col22:**  · **col23:**  · **col24:**  · **col25:** 
- **Input\ (ASCII):** Encoded\ (Base64) · **Letter (ASCII):** 6-bit\ decimal value · **M:** 19 · **:** 16 · **col5:** Padding · **col6:** Padding
- **Input\ (ASCII):** Letter\ (Base64 alphabet) · **Letter (ASCII):** T · **M:** Q · **:** = · **col5:** =
- **Input\ (ASCII):** byte · **Letter (ASCII):** 84 · **M:** 81 · **:** 61 · **col5:** 61
...
- **Encoded:** .mw-parser-output .monospaced{font-family:monospace,monospace}bGlnaHQgdw== · **Padding:** `==` · **Length:** 1 · **Decoded:** _light w_
- **Encoded:** bGlnaHQgd28= · **Padding:** `=` · **Length:** 2 · **Decoded:** _light wo_
- **Encoded:** bGlnaHQgd29y · **Padding:** None · **Length:** 3 · **Decoded:** _light wor_
...
- **Encoded:** bGlnaHQgdw · **Length\ of last group:** 2 · **"missing" bytes:** 2 · **Decoded:** _light w_ · **Decoded length\ of last group:** 1
- **Encoded:** bGlnaHQgd28 · **Length\ of last group:** 3 · **"missing" bytes:** 1 · **Decoded:** _light wo_ · **Decoded length\ of last group:** 2
- **Encoded:** bGlnaHQgd29y · **Length\ of last group:** 4 · **"missing" bytes:** 0 · **Decoded:** _light wor_ · **Decoded length\ of last group:** 3
...
- **Encoding[12]:** 62nd · **Specification:** 63rd · **Alphabet:** pad · **Lines:** Separators · **col5:** Length · **col6:** Checksum
- **Encoding[12]:** Base 64 Encoding · **Specification:** [RFC 4648 §4](https://datatracker.ietf.org/doc/html/rfc4648#section-4) · **Alphabet:** `+` · **Lines:** `/` · **col5:** `=` · **col6:** No · **col7:**  · **col8:** No
- **Encoding[12]:** Base 64 Encoding with URL and Filename Safe Alphabet · **Specification:** [RFC 4648 §5](https://datatracker.ietf.org/doc/html/rfc4648#section-5) · **Alphabet:** `-` · **Lines:** `_` · **col5:** `=`\ optional · **col6:** No · **col7:**  · **col8:** No
- **Encoding[12]:** for [MIME](https://en.wikipedia.org/wiki/Base64#MIME) · **Specification:** [RFC 2045](https://datatracker.ietf.org/doc/html/rfc2045) · **Alphabet:** `+` · **Lines:** `/` · **col5:** `=` · **col6:** Yes · **col7:** 76 · **col8:** No
- **Encoding[12]:** for [Privacy-Enhanced Mail](https://en.wikipedia.org/wiki/Base64#Privacy-enhanced_mail) (deprecated) · **Specification:** [RFC 1421](https://datatracker.ietf.org/doc/html/rfc1421) · **Alphabet:** `+` · **Lines:** `/` · **col5:** `=` · **col6:** Yes · **col7:** 64 · **col8:** Yes, in PEM CRC
- **Encoding[12]:** for [UTF-7](https://en.wikipedia.org/wiki/Base64#UTF-7) · **Specification:** [RFC 2152](https://datatracker.ietf.org/doc/html/rfc2152) · **Alphabet:** `+` · **Lines:** `/` · **col5:**  · **col6:** No · **col7:**  · **col8:** No
- **Encoding[12]:** for IMAP mailbox names · **Specification:** [RFC 3501](https://datatracker.ietf.org/doc/html/rfc3501#section-5.1.3) · **Alphabet:** `+` · **Lines:** `,` · **col5:**  · **col6:** No · **col7:**  · **col8:** No
- **Encoding[12]:** Textual Encodings of PKIX, PKCS, and CMS Structures · **Specification:** [RFC 7468](https://datatracker.ietf.org/doc/html/rfc7468) · **Alphabet:** `+` · **Lines:** `/` · **col5:** `=` · **col6:** Yes · **col7:** 64 · **col8:** No
- **Encoding[12]:** ASCII armor for [OpenPGP](https://en.wikipedia.org/wiki/Base64#OpenPGP) · **Specification:** [RFC 9580](https://datatracker.ietf.org/doc/html/rfc9580) · **Alphabet:** `+` · **Lines:** `/` · **col5:** `=` · **col6:** Yes · **col7:** 76 · **col8:** Yes, (CRC24)
